...
### Buildbot setup with an Ubuntu AMI

Assuming an Ubuntu 18.04 or 20.04 AMI, do the following:
...
# Logout as ubuntu, and login as buildbot
...
# Copy over your password.py to zfs-buildbot/master

# Next, do a one-time update of its buildbot's database:
cd zfs-buildbot/master
buildbot upgrade-master .

# From then on, you can startup buildbot with
buildbot start .
```
